...
export const SEVERITY_META: Record<string, { label: string; color: string; bg: string; borderColor: string }> = {
  kabira: { label: "كبيرة", color: "text-red-500", bg: "bg-red-500/15", borderColor: "border-red-400/40" },
  saghira: { label: "صغيرة", color: "text-amber-500", bg: "bg-amber-500/15", borderColor: "border-amber-400/40" },
};
